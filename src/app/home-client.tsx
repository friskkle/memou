    ...
    <main className="flex-1 font-sans h-dvh overflow-y-auto overflow-x-hidden snap-y snap-mandatory scroll-smooth bg-transparent text-stone-900">
      ...
      <section className="snap-always min-h-dvh w-full snap-start flex flex-col items-center justify-center p-8 md:p-20 relative">
        ...
        >
          ...
          >
            Welcome to <span className="italic text-jbrown">Memou</span>
          </motion.h1>
          <motion.p
            variants={sectionVariants}
            className="text-xl sm:text-2xl text-stone-600 max-w-2xl mx-auto font-light mt-6"
          >
            Your personal space to capture thoughts, ideas, and memories with
      ...
      <section className="snap-always min-h-dvh w-full snap-start flex flex-col items-center justify-between pl-8 md:pl-20 py-8 md:py-20">
        ...
        >
          <div className="space-y-6 pr-8 text-left">
            ...
            >
              Memou provides a simple collaborative environment to log your
              memories and thoughts, all you have to do is type, and Memou will
              handle the rest.
            </motion.p>
            <motion.ul
              variants={containerVariants}
              className="space-y-4 pt-4 text-stone-600 text-lg select-none"
            >
              <motion.li
                variants={sectionVariants}
      ...
      <section className="snap-always min-h-dvh w-full snap-start flex flex-col items-center justify-center p-8 md:p-20 bg-[#D49273] text-white relative overflow-hidden">
        ...
        ></div>
        <div
          className="absolute left-0 bottom-0 w-[60vh] h-[60vh] bg-black/10 rounded-full blur-[100px] translate-y-1/3 -translate-x-1/3"
          aria-hidden="true"
        ></div>
        ...
        >
          <motion.div
            variants={sectionVariants}
            className="inline-block px-5 py-2 rounded-full border border-white/30 bg-white/10 backdrop-blur-md text-sm font-medium tracking-widest uppercase shadow-sm"
          >
            Zero Cost
          </motion.div>
          <motion.h2
          ...
          >
            No paywalls. No premium tiers. No hidden costs. Because your inner
            thoughts shouldn&apos;t come with a price tag.
          </motion.p>
        ...
        >
          <motion.div variants={sectionVariants} className="space-y-6">
            ...
            <p className="text-xl text-stone-400 font-light leading-relaxed max-w-xl mx-auto">
              Memou is a public open-source project, initially made as a private
              project for me and my close ones to share notes without any
              restrictions or relying on public services.
            </p>
            <br />
            <p className="text-xl text-stone-400 font-light leading-relaxed max-w-xl mx-auto">
              You can contribute to the project, report issues, or just check
              out how it works under the hood.
            </p>
          </motion.div>
          ...
          >
            <svg
              className="w-8 h-8 fill-current group-hover:rotate-360 transition-transform duration-700 ease-in-out"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
              aria-hidden="true"
            >
